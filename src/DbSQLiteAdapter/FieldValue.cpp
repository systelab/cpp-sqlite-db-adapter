...
FieldValue::FieldValue(const IField &field)
    : m_field(field), m_nullValue(true), m_default(false), m_boolValue(false),
      m_intValue(0), m_doubleValue(0.), m_stringValue(""), m_dateTimeValue(),
      m_binaryValue() {}

FieldValue::FieldValue(const IField &field, bool value)
    : m_field(field), m_nullValue(false), m_default(false), m_boolValue(value),
      m_intValue(0), m_doubleValue(0.), m_stringValue(""), m_dateTimeValue(),
      m_binaryValue() {
...
FieldValue::FieldValue(const IField &field, int value)
    : m_field(field), m_nullValue(false), m_default(false), m_boolValue(false),
      m_intValue(value), m_doubleValue(0.), m_stringValue(""),
      m_dateTimeValue(), m_binaryValue() {
...
FieldValue::FieldValue(const IField &field, double value)
    : m_field(field), m_nullValue(false), m_default(false), m_boolValue(false),
      m_intValue(0), m_doubleValue(value), m_stringValue(""), m_dateTimeValue(),
      m_binaryValue() {
...
FieldValue::FieldValue(const IField &field, const std::string &value)
    : m_field(field), m_nullValue(false), m_default(false), m_boolValue(false),
      m_intValue(0), m_doubleValue(0.), m_stringValue(value), m_dateTimeValue(),
      m_binaryValue() {
...
const IField &FieldValue::getField() const { return m_field; }

bool FieldValue::isNull() const { return m_nullValue; }

bool FieldValue::isDefault() const { return m_default; }
  ...
  if (isNull()) {
    ...
    case DOUBLE:
      return std::unique_ptr<IFieldValue>(
          new FieldValue(m_field, m_doubleValue));

    case STRING:
      return std::unique_ptr<IFieldValue>(
          new FieldValue(m_field, m_stringValue));

    case DATETIME:
      return std::unique_ptr<IFieldValue>(
          new FieldValue(m_field, m_dateTimeValue));
