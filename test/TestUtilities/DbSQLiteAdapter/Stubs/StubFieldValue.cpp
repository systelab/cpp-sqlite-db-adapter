...
StubFieldValue::StubFieldValue(const db::IFieldValue &other)
    : m_nullValue(other.isNull()), m_default(other.isDefault()),
      m_boolValue(false), m_intValue(0), m_doubleValue(0.), m_stringValue(""),
      m_dateTimeValue() {
...
StubFieldValue::StubFieldValue(const StubFieldValue &other)
    : m_nullValue(other.m_nullValue), m_default(other.m_default),
      m_boolValue(other.m_boolValue), m_intValue(other.m_intValue),
      m_doubleValue(other.m_doubleValue), m_stringValue(other.m_stringValue),
...
StubFieldValue::StubFieldValue(const std::string &name)
    : m_nullValue(true), m_default(false), m_boolValue(false), m_intValue(0),
      m_doubleValue(0.), m_stringValue(""), m_dateTimeValue() {
  m_field.reset(new StubField(name, db::INT));
}

StubFieldValue::StubFieldValue(const std::string &name, int value)
    : m_nullValue(false), m_default(false), m_boolValue(false),
      m_intValue(value), m_doubleValue(0.), m_stringValue(""),
      m_dateTimeValue() {
  m_field.reset(new StubField(name, db::INT));
}

StubFieldValue::StubFieldValue(const std::string &name, bool value)
    : m_nullValue(false), m_default(false), m_boolValue(value), m_intValue(0),
      m_doubleValue(0.), m_stringValue(""), m_dateTimeValue() {
  m_field.reset(new StubField(name, db::BOOLEAN));
}

StubFieldValue::StubFieldValue(const std::string &name, double value)
    : m_nullValue(false), m_default(false), m_boolValue(false), m_intValue(0),
      m_doubleValue(value), m_stringValue(""), m_dateTimeValue() {
...
StubFieldValue::StubFieldValue(const std::string &name,
    ...
    : m_nullValue(false), m_default(false), m_boolValue(false), m_intValue(0),
      m_doubleValue(0.), m_stringValue(value), m_dateTimeValue() {
...
StubFieldValue::StubFieldValue(const std::string &name,
    ...
    : m_nullValue(false), m_default(false), m_boolValue(false), m_intValue(0),
      m_doubleValue(0.), m_stringValue(""), m_dateTimeValue(value) {
  m_field.reset(new StubField(name, db::DATETIME));
}

StubFieldValue::StubFieldValue(const std::string &name,
                               const boost::optional<int> &value)
    : m_default(false), m_boolValue(false), m_doubleValue(0.),
      m_stringValue(""), m_dateTimeValue() {
  m_field.reset(new StubField(name, db::INT));
...
StubFieldValue::StubFieldValue(const std::string &name,
    ...
    : m_default(false), m_intValue(0), m_doubleValue(0.), m_stringValue(""),
      m_dateTimeValue() {
  m_field.reset(new StubField(name, db::BOOLEAN));
...
StubFieldValue::StubFieldValue(const std::string &name,
    ...
    : m_default(false), m_intValue(0), m_boolValue(false), m_stringValue(""),
      m_dateTimeValue() {
  m_field.reset(new StubField(name, db::DOUBLE));
...
StubFieldValue::StubFieldValue(const std::string &name,
    ...
    : m_default(false), m_intValue(0), m_boolValue(false), m_doubleValue(0.),
      m_dateTimeValue() {
  m_field.reset(new StubField(name, db::DOUBLE));
...
const db::IField &StubFieldValue::getField() const { return *m_field; }

bool StubFieldValue::isNull() const { return m_nullValue; }

bool StubFieldValue::isDefault() const { return m_default; }
