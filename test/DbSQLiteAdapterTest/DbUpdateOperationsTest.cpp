...
///**
// * Tests if the update operations over a table performed using the SQLite DB
...
//  void TearDown() { dropTable(*m_db, UPDATE_TABLE_NAME); }
...
//  ITable &getUpdateTable() const { return m_db->getTable(UPDATE_TABLE_NAME); }
...
//      .setDateTimeValue(
//          boost::posix_time::ptime(boost::gregorian::date(2015, 9, 6)));
...
//  std::unique_ptr<ITableRecord> updatedRecord =
//      table.getRecordByPrimaryKey(*primaryKeyValue);
//  ASSERT_EQ(updatedRecord->getFieldValue("FIELD_INT_INDEX").getIntValue(),
//            1234);
//  ASSERT_EQ(updatedRecord->getFieldValue("FIELD_INT_NO_INDEX").getIntValue(),
//            4321);
//  ASSERT_EQ(updatedRecord->getFieldValue("FIELD_STR_INDEX").getStringValue(),
//            std::string("UPDATED_STR"));
//  ASSERT_EQ(updatedRecord->getFieldValue("FIELD_STR_NO_INDEX").getStringValue(),
//            std::string("STR_UPDATED"));
//  ASSERT_EQ(updatedRecord->getFieldValue("FIELD_REAL").getDoubleValue(),
//            6789.1234);
//  ASSERT_EQ(updatedRecord->getFieldValue("FIELD_BOOL").getBooleanValue(),
//            false);
//  ASSERT_EQ(updatedRecord->getFieldValue("FIELD_DATE").getDateTimeValue(),
//            boost::posix_time::ptime(boost::gregorian::date(2015, 9, 6)));
//}
...
//  auxRecord->getFieldValue("FIELD_DATE")
//      .setDateTimeValue(
//          boost::posix_time::ptime(boost::gregorian::date(2012, 4, 5)));
...
//  RowsAffected nRows =
//      table.updateRecordsByCondition(newValues, conditionValues);
//  ASSERT_EQ(nRows, expectedAffectedRows);

//  // Check records have been updated successfully
//  std::unique_ptr<ITableRecordSet> updatedRecordset =
...
//    ASSERT_EQ(
//        updatedRecord.getFieldValue("FIELD_STR_NO_INDEX").getStringValue(),
