...
//#include "../TestUtilities/DbSQLiteAdapter/Mocks/MockConnection.h"
//#include
//"../TestUtilities/DbSQLiteAdapter/Mocks/MockConnectionConfiguration.h"
//#include "../TestUtilities/DbSQLiteAdapter/Mocks/MockDatabase.h"
//#include "../TestUtilities/DbSQLiteAdapter/Mocks/MockTable.h"
...
// protected:
//  systelab::test_utility::MockTable m_table;
//  systelab::test_utility::MockDatabase m_database;
...
//    std::cout << "\nExecution time: "
//              << (endTime - m_startTime).total_milliseconds() << " ms.\n";
//  }

//  void createTable(const systelab::db::sqlite::Connection &connection) {
//    m_db->executeOperation(
//        "CREATE TABLE TESTS(ID INT PRIMARY KEY NOT NULL, FIELD_INT_INDEX INT,
//        " "FIELD_INT_NO_INDEX INT, FIELD_STR_INDEX CHAR(255),
//        FIELD_STR_NO_INDEX " "CHAR(255), FIELD_DATE DATETIME DEFAULT
//        '2016-05-05')");
//    m_db->executeOperation("CREATE INDEX INT_INDEX ON
//    TESTS(FIELD_INT_INDEX)"); m_db->executeOperation("CREATE INDEX STR_INDEX
//    ON TESTS(FIELD_STR_INDEX)");
...
//      std::string strDate = boost::posix_time::to_iso_string(
//          today + (boost::gregorian::days(7 * i)));
//      oss << "INSERT INTO TESTS (ID, FIELD_INT_INDEX, FIELD_INT_NO_INDEX, "
//             "FIELD_STR_INDEX, FIELD_STR_NO_INDEX, FIELD_DATE) VALUES ("
//          << i << ", " << i % 7 << ", " << i % 10 << ", \"STR" << i % 9 <<
//          "\""
//          << ", \"STR" << i % 12 << "\""
//          << ", '" << strDate << "'"
...
//      m_db->executeQuery("SELECT * FROM TESTS WHERE ID = 50");
...
//  std::unique_ptr<IRecordSet> recordSet =
//      m_db->executeQuery("SELECT * FROM TESTS WHERE FIELD_INT_NO_INDEX = 5");
...
//  std::unique_ptr<IRecordSet> recordSet =
//      m_db->executeQuery("SELECT * FROM TESTS WHERE FIELD_INT_INDEX = 5");
...
//      "SELECT * FROM TESTS WHERE FIELD_STR_NO_INDEX = 'STR4'");
...
//  std::unique_ptr<IRecordSet> recordSet =
//      m_db->executeQuery("SELECT * FROM TESTS WHERE FIELD_STR_INDEX =
//      'STR6'");
...
//{
//        std::unique_ptr<IRecordSet> recordSet = m_db->executeQuery("SELECT *
// FROM TESTS WHERE FIELD_DATE BETWEEN '2015-06-01' AND '2016-01-01'");
//        iterateRecordset(*recordSet);
//}*/
...
//  m_db->executeOperation(
//      "INSERT INTO TESTS (ID, FIELD_INT_INDEX, FIELD_INT_NO_INDEX, "
//      "FIELD_STR_INDEX, FIELD_STR_NO_INDEX) VALUES (10001, 5, 5, 'STR5', "
//      "'STR5')");
//}
...
//        today + (boost::gregorian::days(7 * i)));
//    oss << "INSERT INTO TESTS (ID, FIELD_INT_INDEX, FIELD_INT_NO_INDEX, "
//           "FIELD_STR_INDEX, FIELD_STR_NO_INDEX) VALUES ("
//        << i << ", " << i % 7 << ", " << i % 10 << ", 'STR" << i % 9 << "'"
//        << ", 'STR" << i % 12 << "'"
//        << ")";
//    m_db->executeOperation(oss.str());
...
//  m_db->executeOperation(
//      "UPDATE TESTS SET FIELD_INT_NO_INDEX = 100 WHERE ID = 5");
//}

// TEST_F(DbQueriesTest, testUpdateIntFieldIndexed) {
//  m_db->executeOperation("UPDATE TESTS SET FIELD_INT_INDEX = 100 WHERE ID =
//  5");
//}

// TEST_F(DbQueriesTest, testUpdateStringFieldNotIndexed1Row) {
//  m_db->executeOperation(
//      "UPDATE TESTS SET FIELD_STR_NO_INDEX = 'STR100' WHERE ID = 5");
//}

// TEST_F(DbQueriesTest, testUpdateStringFieldIndexed1Row) {
//  m_db->executeOperation(
//      "UPDATE TESTS SET FIELD_STR_INDEX = 'STR100' WHERE ID = 5");
//}
...
//  for (unsigned int i = 0; i < 1000; i++) {
//    std::ostringstream oss;
//    oss << "DELETE FROM TESTS WHERE ID = " << i;
//    m_db->executeOperation(oss.str());
//  }
//}
