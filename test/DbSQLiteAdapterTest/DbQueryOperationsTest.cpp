...
///**
// * Tests if the query operations over a table performed using the SQLite DB
// * adapter return the data stored on that table.
// */
...
//  void TearDown() { dropTable(*m_db, QUERY_TABLE_NAME); }
...
//  ITable &getQueryTable() const { return m_db->getTable(QUERY_TABLE_NAME); }
...
//    int fieldIntNoIndex =
//        record.getFieldValue("FIELD_INT_NO_INDEX").getIntValue();
//    std::string fieldStrIndex =
//        record.getFieldValue("FIELD_STR_INDEX").getStringValue();
//    std::string fieldStrNoIndex =
...
//    boost::posix_time::ptime fieldDateTime =
...
//  getQueryTable().getAllRecords(); ASSERT_EQ(QUERY_TABLE_NUM_RECORDS,
//  recordset->getRecordsCount()); assertRecordSet(*recordset);
//}
...
//  std::unique_ptr<ITableRecord> record =
...
//  std::unique_ptr<IFieldValue> fieldIntIndexValue =
//      table.createFieldValue(fieldIntIndex, 0);

//  unsigned int expectedRecords =
//      getNumRecordsWithFieldIntIndexZero(QUERY_TABLE_NUM_RECORDS);
//  std::unique_ptr<ITableRecordSet> recordset =
//      table.filterRecordsByField(*fieldIntIndexValue);
...
//  std::unique_ptr<IFieldValue> fieldIntNoIndexValue =
//      table.createFieldValue(fieldIntNoIndex, 0);

//  unsigned int expectedRecords =
//      getNumRecordsWithFieldIntNoIndexZero(QUERY_TABLE_NUM_RECORDS);
//  std::unique_ptr<ITableRecordSet> recordset =
//      table.filterRecordsByField(*fieldIntNoIndexValue);
//  ASSERT_EQ(expectedRecords, recordset->getRecordsCount());
...
//  std::unique_ptr<IFieldValue> fieldStrIndexValue =
//      table.createFieldValue(fieldStrIndex, std::string("STR0"));

//  unsigned int expectedRecords =
//      getNumRecordsWithFieldStringIndexZero(QUERY_TABLE_NUM_RECORDS);
//  std::unique_ptr<ITableRecordSet> recordset =
//      table.filterRecordsByField(*fieldStrIndexValue);
//  ASSERT_EQ(expectedRecords, recordset->getRecordsCount());
...
//  std::unique_ptr<IFieldValue> fieldStrNoIndexValue =
//      table.createFieldValue(fieldStrNoIndex, std::string("STR0"));

//  int expectedRecords =
//      getNumRecordsWithFieldStringNoIndexZero(QUERY_TABLE_NUM_RECORDS);
//  std::unique_ptr<ITableRecordSet> recordset =
//      table.filterRecordsByField(*fieldStrNoIndexValue);
//  ASSERT_EQ(expectedRecords, recordset->getRecordsCount());
...
//  std::unique_ptr<IFieldValue> fieldRealValue =
//      table.createFieldValue(fieldReal, 0.);

//  int expectedRecords =
//  getNumRecordsWithFieldRealZero(QUERY_TABLE_NUM_RECORDS);
//  std::unique_ptr<ITableRecordSet> recordset =
//      table.filterRecordsByField(*fieldRealValue);
//  ASSERT_EQ(expectedRecords, recordset->getRecordsCount());
...
//  std::unique_ptr<IFieldValue> fieldBoolValue =
//      table.createFieldValue(fieldBool, true);

//  int expectedRecords =
//  getNumRecordsWithFieldBoolTrue(QUERY_TABLE_NUM_RECORDS);
//  std::unique_ptr<ITableRecordSet> recordset =
//      table.filterRecordsByField(*fieldBoolValue);
//  ASSERT_EQ(expectedRecords, recordset->getRecordsCount());
...
//  std::unique_ptr<IFieldValue> fieldDateValue =
//      table.createFieldValue(fieldDate, baseDate);

//  int expectedRecords =
//      getNumRecordsWithFieldDateIsBaseDate(QUERY_TABLE_NUM_RECORDS);
//  std::unique_ptr<ITableRecordSet> recordset =
//      table.filterRecordsByField(*fieldDateValue);
//  ASSERT_EQ(expectedRecords, recordset->getRecordsCount());

//  while (recordset->isCurrentRecordValid()) {
//    const ITableRecord &record = recordset->getCurrentRecord();
//    ASSERT_EQ(record.getFieldValue("FIELD_DATE").getDateTimeValue(),
//    baseDate); assertRecord(record); recordset->nextRecord();
//  }
//}
